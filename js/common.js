    ...
    switch(zip_case) {
        case 1 :    //iframe�� �댁슜�섏뿬 �섏씠吏��� �쇱썙 �ｊ린
            ...
            if (element_wrap == null) {
                ...
                element_wrap.innerHTML = '<img src="//t1.daumcdn.net/postcode/resource/images/close.png" id="btnFoldWrap" style="cursor:pointer;position:absolute;right:0px;top:-21px;z-index:1" class="close_daum_juso" alt="�묎린 踰꾪듉">';
